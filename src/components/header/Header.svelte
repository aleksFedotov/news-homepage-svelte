<script>
    import HeaderRigthDesktop from "./headerRigthDesktop.svelte"
    let innerWidth = 1440
    import ModalStore from "../../store/modalStore";

    const clickHandler = (e) => {
     
        ModalStore.update((curerntState) => {
            curerntState = {...curerntState, isOpen: true}
            return curerntState
        })
    }
...
<header>
    ...
    <HeaderRigthDesktop/>
    {:else}
    <div class="menu_btn_wrapper" on:click={clickHandler} on:keydown={() =>{}}> 
